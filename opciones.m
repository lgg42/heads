...
% OPCIONES M-file for opciones.fig
...
% Last Modified by GUIDE v2.5 24-Mar-2010 19:47:39
...
set(handles.edit1,'String',separadorcampo);

load('opciones.mat', 'separadordecimal');
set(handles.edit2,'String',separadordecimal);

load('opciones.mat', 'statsproc');
set(handles.checkbox1,'Value',statsproc);

load('opciones.mat', 'checkconsistencia');
set(handles.checkbox2,'Value',checkconsistencia);

load('opciones.mat', 'errorP');
set(handles.edit4,'String',int2str(errorP));

load('opciones.mat', 'errorQ');
set(handles.edit5,'String',int2str(errorQ));

load('opciones.mat', 'minsamples');
set(handles.edit6,'String',int2str(minsamples));
...
separadorcampo = get(handles.edit1,'String');
separadordecimal = get(handles.edit2,'String');
errorP = str2double(get(handles.edit4,'String'));
errorQ = str2double(get(handles.edit5,'String'));
minsamples = str2double(get(handles.edit6,'String'));
save('opciones.mat', 'separadorcampo', '-append');
save('opciones.mat', 'separadordecimal', '-append');
save('opciones.mat', 'errorP', '-append');
save('opciones.mat', 'errorQ', '-append');
save('opciones.mat', 'minsamples', '-append');
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
path = uigetdir('','Seleccione Carpeta con Base de Datos');
...
statsproc = get(hObject,'Value');
save('opciones.mat', 'statsproc', '-append');
...
checkconsistencia = get(hObject,'Value');
save('opciones.mat', 'checkconsistencia', '-append');
