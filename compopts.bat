...
rem ********************************************************************
set MATLAB=%MATLAB%
set VSINSTALLDIR=C:\Archivos de programa\Microsoft Visual Studio 9.0
set VCINSTALLDIR=%VSINSTALLDIR%\VC
rem In this case, LINKERDIR is being used to specify the location of the SDK
set LINKERDIR=C:\Archivos de programa\\Microsoft SDKs\Windows\v6.0A\
...
set INCLUDE=%VCINSTALLDIR%\ATLMFC\INCLUDE;%VCINSTALLDIR%\INCLUDE;%LINKERDIR%\include;%INCLUDE%;%MSVCDir% tlmfcnclude
